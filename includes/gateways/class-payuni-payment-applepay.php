<?php
/**
 * Payuni_Payment_ApplePay class file
 *
 * @package payuni
 */
...
/**
 * Payuni_Payment_ApplePay class for Apple Pay payment
 */
class Payuni_Payment_ApplePay extends Payuni_Abstract_Payment_Gateway {
	...
	public function init_form_fields() {
		$this->form_fields = include WPBR_PAYUNI_PLUGIN_DIR . 'includes/settings/settings-payuni-payment-applepay.php';
	}

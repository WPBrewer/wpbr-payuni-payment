...
class Payuni_Payment_GooglePay extends Payuni_Abstract_Payment_Gateway {
	...
	public function __construct() {
		...
		$this->method_title       = __( 'PAYUNi Google Pay Payment', 'woo-payuni-payment' );
		$this->method_description = __( 'PAYUNi Google Pay Payment', 'woo-payuni-payment' );
		$this->supports           = array(
			'products',
			'refunds',
		);
	...
	public function init_form_fields() {
		$this->form_fields = include PAYUNI_PLUGIN_DIR . 'includes/settings/settings-payuni-payment-googlepay.php';
	}

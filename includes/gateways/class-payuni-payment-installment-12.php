...
class Payuni_Payment_Installment_12 extends Payuni_Abstract_Payment_Gateway {
	...
	public function __construct() {
		...
		$this->method_title       = __( 'PAYUNi Installment Payment (12 Installments)', 'woo-payuni-payment' );
		$this->method_description = __( 'PAYUNi Installment Payment (12 Installments)', 'woo-payuni-payment' );

<?php
/**
 * Payuni_Payment_SamsungPay class file
 *
 * @package payuni
 */
...
/**
 * Payuni_Payment_SamsungPay class for Samsung Pay payment
 */
class Payuni_Payment_SamsungPay extends Payuni_Abstract_Payment_Gateway {
	...
	public function init_form_fields() {
		$this->form_fields = include WPBR_PAYUNI_PLUGIN_DIR . 'includes/settings/settings-payuni-payment-samsungpay.php';
	}

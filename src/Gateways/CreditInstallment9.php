...
class CreditInstallment9 extends GatewayBase {
	...
	const GATEWAY_ID = 'payuni-upp-installment-9';
	...
	public function __construct() {
		...
		$this->method_title       = __( 'PAYUNi Installment Payment (9 Installments)', 'wpbr-payuni-payment' );
		$this->method_description = __( 'PAYUNi Installment Payment (9 Installments)', 'wpbr-payuni-payment' );
